...
import com.app.firebase_auth.databinding.ActivityOtpBinding
...
class OtpActivity : AppCompatActivity() {
    ...
    private fun firebaseCallback(): PhoneAuthProvider.OnVerificationStateChangedCallbacks  {
...
//                signInWithPhoneAuthCredential(credential)
    ...
    fun signIn(){
        val code = binding.tiCode.text.toString()
